...
export type actionTypes = 'GET_USERS' | 'EDIT_USER' | 'DELETE_USER' | 'USERS_LOADING' | "USER_LOADING" | "USER_LOADED" | "AUTH_ERROR" | "LOGIN_SUCCESS" | "LOGIN_FAIL" | "LOGOUT" | "REGISTER_SUCCESS" | "REGISTER_FAIL" | 'GET_ERRORS' | 'CLEAR_ERRORS' | 'SET_ACTIVE_USER'